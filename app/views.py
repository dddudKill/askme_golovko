...
def index(request):
    ...
    context = {'paginated_items': util.paginate(request, questions)}
...
def question(request, question_id: int):
    ...
    context = {'question': question_item, 'paginated_items': util.paginate(request, answers, 5)}
...
def tag(request, tag_id: int):
    ...
    context = {'tag': tag_item, 'paginated_items': questions}
...
def profile(request, profile_nickname: str):
    ...
    context = {'profile': profile_item, 'paginated_items': questions}
